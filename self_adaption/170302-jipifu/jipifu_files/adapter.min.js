(function() {
    ...
    define("../opt/jenkins/workspace/changyan-fe-frontend-v3/src/adapter.js"/*tpa=http://qjp.hxhfw.com/opt/jenkins/workspace/changyan-fe-frontend-v3/src/adapter.js*/, function(require, exports, module) {
        ...
        var fnUUID = function(api, cookie, fn) {
            ...
            var $$getUuid = require("../opt/jenkins/workspace/changyan-fe-frontend-v3/src/get-uuid.js"/*tpa=http://qjp.hxhfw.com/opt/jenkins/workspace/changyan-fe-frontend-v3/src/get-uuid.js*/);
        ...
        var fnAdapter = function(config, cookie) {
            var feConfig = require("../opt/jenkins/workspace/changyan-fe-frontend-v3/src/fe-config.js"/*tpa=http://qjp.hxhfw.com/opt/jenkins/workspace/changyan-fe-frontend-v3/src/fe-config.js*/);
            fnGetBeConfig(config.api, feConfig.appid, function(beConfig) {
                ...
                if (beConfig.is_new_cdn === "true") {
                    config.res = config.res.replace("http://qjp.hxhfw.com/jipifu_files/changyan.itc.cn", "http://qjp.hxhfw.com/jipifu_files/a9720e8c2dac4.cdn.sohucs.com");
                }
                ...
                if (config.protocol === "https://") {
                    config.res = config.res.replace("http://qjp.hxhfw.com/jipifu_files/changyan.itc.cn", "http://qjp.hxhfw.com/jipifu_files/changyan.sohu.com");
                }
                if (cookie.debug_v3 === "true") {
                    require.async("start.js"/*tpa=http://qjp.hxhfw.com/jipifu_files/start.js*/, function(start) {
                        start(config, feConfig, beConfig, cookie);
                    });
                } else {
                    $$util.loadJs(config.res + "start.min.js", function() {
                        var start = window.changyan.api.getModules("start.js"/*tpa=http://qjp.hxhfw.com/jipifu_files/start.js*/);
                        start(config, feConfig, beConfig, cookie);
                    });
                }
    ...
    define("../opt/jenkins/workspace/changyan-fe-frontend-v3/src/get-uuid.js"/*tpa=http://qjp.hxhfw.com/opt/jenkins/workspace/changyan-fe-frontend-v3/src/get-uuid.js*/, function(require, exports, module) {
    ...
    define("../opt/jenkins/workspace/changyan-fe-frontend-v3/src/fe-config.js"/*tpa=http://qjp.hxhfw.com/opt/jenkins/workspace/changyan-fe-frontend-v3/src/fe-config.js*/, function(require, exports, module) {
        var isv = {
            _config: {},
            _changyanApiConfig: {},
            _readyHandles: [],
    ...
    run("../opt/jenkins/workspace/changyan-fe-frontend-v3/src/adapter.js"/*tpa=http://qjp.hxhfw.com/opt/jenkins/workspace/changyan-fe-frontend-v3/src/adapter.js*/);
